...
function validarUsu() {
  ...
  if (!user.includes("@")) {
    ...
    mensaje.className="bg-danger m-1 p-1 text-center rounded"
    // document.getElementById("mensaje").style.color="red"
  } else if (!user.toLowerCase().includes("codoacodo.edu.ar")) {  
    mensaje.innerHTML="El usuario debe tener dominio codoACodo.edu.ar"
    mensaje="bg-danger m-1 p-1 text-center rounded"
  } else {
    mensaje.innerHTML=""
    mensaje.className=""
